# Análise Estratégica de Vendas - Jaar Consult
...
```
PS PBI Jaar Consult/
├── assets/                 # Imagens e logo utilizadas no README e no relatório
├── data/
│   ├── processed/          # Dados transformados e prontos para uso (quando salvos)
...
- **Markdown:** Para documentação técnica do projeto.

---
*Desenvolvido por Diego Pablo Menezes para avaliação na Jaar Consult.*
